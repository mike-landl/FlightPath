...
namespace FlightPath
{
    ...
    {
        CheckReal<float>(-0.88973_km_f, -889.73);
        CheckReal<float>( 1.0_km_f,     1000.0 );
        CheckReal<float>( 2.45589_km_f, 2455.89);
    }

    TEST_CASE("[Units] m float literal", "[Units]")
    {
        CheckReal<float>(   -0.54690_m_f,    -0.54690);
        CheckReal<float>(    1.0_m_f,         1.0    );
        CheckReal<float>(46657.0_m_f,     46657.0    );
    }

    TEST_CASE("[Units] mm float literal", "[Units]")
    {
        CheckReal<float>(   -0.00468_mm_f, -0.00000468);
        CheckReal<float>(    1.0_mm_f,      0.001     );
        CheckReal<float>(45668.0_mm_f,     45.668     );
    }

    TEST_CASE("[Units] feet float literal", "[Units]")
    {
        CheckReal<float>(   -0.00468_ft_f, -0.001426464);
        CheckReal<float>(    1.0_ft_f,      0.3048     );
        CheckReal<float>(45668.0_ft_f,     13919.6064  );
    }
